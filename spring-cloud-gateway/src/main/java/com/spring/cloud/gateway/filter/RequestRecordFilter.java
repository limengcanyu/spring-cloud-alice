...
/**
 * <p>Description: Request Record Filter </p>
 * spring cloud gateway为了记录访问记录,需要记录请求体里面的内容,但是 request body是只能读取一次的,
 * 如果读取以后不封装回去,则会造成后面的服务无法读取body数据. 在网关里添加一个过滤器RequestRecordFilter类
 *
 * @author rock.jiang
...
public class RequestRecordFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        logger.debug("Request Record filter ====================================== ");
